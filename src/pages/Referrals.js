...
const Referrals = () => {
  ...
  const referralLink = 'https://licrown.ai/auth/sign-up?ref=SHIFASALMAN';
  const referralCode = 'SHIFASALMAN3986';
          ...
          <div className="col-lg-6">
            <div className="wallet-card">
              ...
              <div className="d-flex align-items-center mb-3">
                <h2 className="text-white fw-bold mb-0">$ {referralEarning.toFixed(0)}</h2>
              ...
              <p className="text-gray small mb-2">
                ${(1 - referralEarning).toFixed(2)} more needed to claim
              </p>
            ...
            <div className="row g-3 mb-3">
              ...
              <div className="col-6">
                <div className="stat-card">
                  ...
                  <h4 className="text-white fw-bold mb-0">$0.00</h4>
                </div>
              </div>
              {/* Total Referrals */}
              <div className="col-6">
